...
M.base_30 = {
	...
	one_bg3 = lighten("{{colors.background.default.hex | lighten: -2.5}}", 22),
	...
	statusline_bg = lighten("{{colors.background.default.hex | lighten: -2.5}}", 6),
	pmenu_bg = "{{colors.surface_variant.default.hex}}",
	folder_bg = lighten("{{colors.primary_fixed_dim.default.hex}}", 0),
	lightbg = lighten("{{colors.background.default.hex | lighten: -2.5}}", 10),
}

M.base_16 = {
	base00 = "{{colors.background.default.hex | lighten: -2.5}}",
	...
	base07 = "{{colors.background.default.hex | lighten: -2.5}}",
